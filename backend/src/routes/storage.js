...
module.exports = (app) => {
    ...
    app.put('/api/storage/sell/:id', authenticate, StorageController.validate('sellItemByStorageId'), StorageController.sellItemByStorageId);
    app.put('/api/storage/receive/:id', authenticate, StorageController.validate('receiveItemByStorageId'), StorageController.receiveItemByStorageId);
